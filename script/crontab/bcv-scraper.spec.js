...
describe('BCV Scraper Cron Script', () => {
  ...
  beforeEach(() => {
    ...
    // Global fallback to prevent real network requests during tests
    jest.spyOn(axios, 'get').mockRejectedValue(new Error('Network call prevented by global test mock'));
